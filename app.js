...
let reviews = [
    {
        image: "https://img.freepik.com/premium-photo/portrait-of-successful-man-30s-with-bristle-wearing-casual-t-shirt-smiling-isolated-on-white_171337-91830.jpg",
        name: "Геннадий",
        advantage:
            "Мак просто великолепен! Удобный в использовании, быстрый и современный!",
    ...
    {
        image: "https://img.freepik.com/free-photo/portrait-of-beautiful-mature-blonde-bearded-guy-with-trendy-hairdo-in-casual-grey-shirt-smiling_176420-15741.jpg",
        name: "Евгений",
        advantage:
            "Невероятная производительность, за свою цену. Потрясающая автономность (просто забываешь, что такое - брать с собой зарядку). Дизайн выше всяких похвал. Отсутствие активного охлаждения (оно просто не требуется).)",
    ...
    },
    {
        ...
        name: "Даниил",
        advantage:
            "Тачпад, дизайн, ОС, время автономной работы, производительность",
        deficiency:
            "2 Type C с одной стороны. Могли бы сделать по разные стороны",
    ...
    {
        image: "https://img.freepik.com/free-photo/portrait-of-handsome-brunet-unshaven-adult-man-looks-with-calm-confident-expression-has-serious-look-wears-casual-jumper-poses-for-making-photo-against-white-background-being-hard-to-impress_273609-57668.jpg",
        name: "Иван",
        advantage:
            "Ноутбук можно использовать для выполнения повседневных задач, а также для обработки ресурсоемких профессиональных приложений, для проведения досуга за популярными видеоиграми, обладающими высокими требованиями.",
        deficiency: "Нет",
...
safeReview.addEventListener("click", () => {
    ...
    const review = {
        image: "https://www.meme-arsenal.com/memes/13c54859c5ddde3bab2e50f534fcfb11.jpg",
        name: nameReview,
